...
const DrupalProjectStats = ({ projectName }) => {
  ...
  }, [project]); // The second argument is used to skip running the effect function unless the value of the passed in variable(=project) changes.
  ...
  return (
    <div>
      <div>
        ...
        {/* This effectively changes the value of project, and more importantly, causes a rerender of the component. - DrupalProjectState function is called again */}
        {/* This time, project hasn't changed so the fetch code isn't called again */}
